...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <!--begin::Form-->
            <form class="form" action="{{ route('barang_keluar_detail-save', isset($id) ? $id : '') }}" method="POST">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-lg-6">
                            <a href="{{route('barang_keluar_detail', isset($id) ? $id : '')}}" class="btn btn-warning">Back</a>
                        </div>
